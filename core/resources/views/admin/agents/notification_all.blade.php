    ...
    <script>
        ...
        (function($) {
            ...
            $('select[name=being_sent_to]').on('change', function(e) {
                ...
                if (methodName == 'SELECTEDAGENTS') {
                    ...
                    <div class="form-group" id="user_list_wrapper">
                        <label class="required">@lang('Select Agent')</label>
                ...
                if (methodName == 'TOPDEPOSITEDAGENTS') {
                    $('.input-append').html(`
                    <div class="form-group">
                        <label class="required">@lang('Number Of Add Money Agent')</label>
            ...
            function getUserCount(methodName) {
                ...
                if (methodNameUpper == 'SELECTEDAGENTS' || methodNameUpper == 'ALLAGENTS' || methodNameUpper == 'TOPDEPOSITEDAGENTS' ||
