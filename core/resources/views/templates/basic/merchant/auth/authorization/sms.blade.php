          ...
          <div class="verification-code-wrapper">
              <div class="verification-area">
                  ...
                  <form action="{{route('merchant.verify.mobile')}}" method="POST" class="submit-form">
                      ...
                      <div class="mb-3">
                        <p>
                            @lang('If you don\'t get any code'), <span class="countdown-wrapper">@lang('try again after') <span id="countdown" class="fw-bold">--</span> @lang('seconds')</span> <a href="{{route('merchant.send.verify.code', 'sms')}}" class="try-again-link d-none"> @lang('Try again')</a>
                        </p>
